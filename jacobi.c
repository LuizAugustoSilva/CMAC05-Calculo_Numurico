...
void printPasso(int k, double **matriz, double *termos, double *resultsTemp, double *estimativa, int N);
...
int main()
{
    ...
    while(erro > precisao)
    {
        ...
        printPasso(k, matriz, termos, resultsTemp, estimativa, N);
